...
void PCF_Wr(char dato){
    I2C1_Write(DIR_PCF, dato | LED_STATUS);
}
void loadPCF(char dato, char mode){

    switch(mode){
        case 0: dato &= ~(1<<0); break;
        case 1: dato |= (1<<0); break;
    }
    ...
    dato &= ~(1<<2);
    PCF_Wr(dato);
    _delay((unsigned long)((30)*(64000000/4000000.0)));
...
void I2C_LCD_Init(void){
    ...
    I2C_LCD_Cmd( 0x20 | 0x00 | 0x08 | 0x00 );
    _delay((unsigned long)((37)*(64000000/4000000.0)));

    _lcd_params = 0x04 | 0x02 | 0x01;
    I2C_LCD_Cmd(0x08 | _lcd_params);
    _delay((unsigned long)((37)*(64000000/4000000.0)));
